...
def calc_event_f1(gt, pred):
    ...
    print("anomaly events:",
          anomaly_event_hit.shape[0], "anomaly events hits:", anomaly_event_hit.sum())
    print("origin positives:", pred.sum(),
          "predicted events:", len(pred_groups))
